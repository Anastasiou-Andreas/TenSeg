...
# coefficient set at 0.7. First, the user needs to run all the functions in
# the main.R script
#===============================================================
...
for (i in 1:100){
  print(i)
  Tensors_0_cpt_20_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = integer(0), size = 200, dens = 0.2, ac = 0.7, par_decom = 20)
}
...
for (i in 1:100){
  print(i)
  Tensors_0_cpt_10_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = integer(0), size = 200, dens = 0.2, ac = 0.7,par_decom = 10)
}
...
for (i in 1:100){
  print(i)
  Tensors_0_cpt_5_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = integer(0), size = 200, dens = 0.2, ac = 0.7,par_decom = 5)
}
...
for (i in 1:100){
  print(i)
  Tensors_1_cpt_20_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = 100, size = 200, dens = c(0.2,0.8), ac = 0.7,par_decom = 20)
}
...
for (i in 1:100){
  print(i)
  Tensors_1_cpt_10_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = 100, size = 200, dens = c(0.2,0.8), ac = 0.7, par_decom = 10)
}
...
for (i in 1:100){
  print(i)
  Tensors_1_cpt_5_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = 100, size = 200, dens = c(0.2,0.8), ac = 0.7, par_decom = 5)
}
...
for (i in 1:100){
  print(i)
  Tensors_4_cpt_20_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = c(100,150,200,250), ac = 0.7, size = 300, dens = c(0.2,0.8,0.2,0.8,0.2), par_decom = 20)
}
...
for (i in 1:100){
  print(i)
  Tensors_4_cpt_10_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = c(100,150,200,250), ac = 0.7,size = 300, dens = c(0.2,0.8,0.2,0.8,0.2), par_decom = 10)
}
...
for (i in 1:100){
  print(i)
  Tensors_4_cpt_5_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = c(100,150,200,250), ac = 0.7,size = 300, dens = c(0.2,0.8,0.2,0.8,0.2), par_decom = 5)
}
...
for (i in 1:100){
  print(i)
  Tensors_10_cpt_20_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = c(60,120,180,240,300,360,420,480,540,600), ac = 0.7,size = 660, dens = c(0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2), par_decom = 20)
}
...
for (i in 1:100){
  print(i)
  Tensors_10_cpt_10_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = c(60,120,180,240,300,360,420,480,540,600), ac = 0.7,size = 660, dens = c(0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2), par_decom = 10)
}
...
for (i in 1:100){
  print(i)
  Tensors_10_cpt_5_components[[i]] <- tensor_creation_decomposition_AR(dims = c(20,20,20), N = c(60,120,180,240,300,360,420,480,540,600), ac = 0.7,size = 660, dens = c(0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2), par_decom = 5)
}
...
table(SIM10_cp_TenSeg_5_components$IDLinf_IC@dnc)
mean(SIM10_cp_TenSeg_5_components$IDLinf_IC@time)
mean(SIM10_cp_TenSeg_5_components$IDLinf_IC@dh)
...
for (i in 1:100){
  print(i)
  ER_Tensors_0_cpt_20_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = integer(0), size = 200, dens = 20, wmin = 0.7, wmax = 0.9, decomp = "cp", par_decom = 20, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_0_cpt_10_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = integer(0), size = 200, dens = 20, wmin = 0.7, wmax = 0.9, decomp = "cp", par_decom = 10, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_0_cpt_5_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = integer(0), size = 200, dens = 20, wmin = 0.7, wmax = 0.9, decomp = "cp", par_decom = 5, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_1_cpt_20_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = 100, size = 200, dens = 20, wmin = c(0.7, 0.1), wmax = c(0.9, 0.2), decomp = "cp", par_decom = 20, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_1_cpt_10_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = 100, size = 200, dens = 20, wmin = c(0.7, 0.1), wmax = c(0.9, 0.2), decomp = "cp", par_decom = 10, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_1_cpt_5_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = 100, size = 200, dens = 20, wmin = c(0.7, 0.1), wmax = c(0.9, 0.2), decomp = "cp", par_decom = 5, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_4_cpt_20_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = c(100, 150, 200, 250), size = 300, dens = 20, wmin = c(0.7,0.1,0.7,0.1,0.7), wmax = c(0.9,0.2,0.9,0.2,0.9), decomp = "cp", par_decom = 20, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_4_cpt_10_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = c(100, 150, 200, 250), size = 300, dens = 20, wmin = c(0.7,0.1,0.7,0.1,0.7), wmax = c(0.9,0.2,0.9,0.2,0.9), decomp = "cp", par_decom = 10, ac =0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_4_cpt_5_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = c(100, 150, 200, 250), size = 300, dens = 20, wmin = c(0.7,0.1,0.7,0.1,0.7), wmax = c(0.9,0.2,0.9,0.2,0.9), decomp = "cp", par_decom = 5, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_10_cpt_20_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = c(60, 120, 180, 240,300,360,420,480,540,600), size = 660, dens = 20, wmin = c(0.7,0.1,0.7,0.1,0.7,0.1,0.7,0.1,0.7,0.1,0.7), wmax = c(0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9), decomp = "cp", par_decom = 20, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_10_cpt_10_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = c(60, 120, 180, 240,300,360,420,480,540,600), size = 660, dens = 20, wmin = c(0.7,0.1,0.7,0.1,0.7,0.1,0.7,0.1,0.7,0.1,0.7), wmax = c(0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9), decomp = "cp", par_decom = 10, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  ER_Tensors_10_cpt_5_components[[i]] <- tensor_creation_decomposition_ER(dims = c(20,20,20), N = c(60, 120, 180, 240,300,360,420,480,540,600), size = 660, dens = 20, wmin = c(0.7,0.1,0.7,0.1,0.7,0.1,0.7,0.1,0.7,0.1,0.7), wmax = c(0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9,0.2,0.9), decomp = "cp", par_decom = 5, ac=0.7)
}
...
table(ER_SIM4_cp_TenSeg_20_components$IDLinf_IC@dnc)
mean(ER_SIM10_cp_TenSeg_5_components$IDLinf_IC@time)
mean(ER_SIM10_cp_TenSeg_5_components$IDLinf_IC@dh)
...
for (i in 1:100){
  print(i)
  SB_Tensors_0_cpt_20_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = integer(0), size = 200, rho = 0.8, num_subgraph = 4, decomp = "cp", par_decom = 20, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_0_cpt_10_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = integer(0), size = 200, rho = 0.8, num_subgraph = 4, decomp = "cp", par_decom = 10, ac = 0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_0_cpt_5_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = integer(0), size = 200, rho = 0.8, num_subgraph = 4, decomp = "cp", par_decom = 5, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_1_cpt_20_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = 100, size = 200, rho = c(0.8,0.2), num_subgraph = c(4,2), decomp = "cp", par_decom = 20, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_1_cpt_10_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = 100, size = 200, rho = c(0.8,0.2), num_subgraph = c(4,2), decomp = "cp", par_decom = 10, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_1_cpt_5_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = 100, size = 200, rho = c(0.8,0.2), num_subgraph = c(4,2), decomp = "cp", par_decom = 5, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_4_cpt_20_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = c(100, 150, 200, 250), size = 300, rho = c(0.8, 0.2, 0.8, 0.2, 0.8), num_subgraph = c(4,2,4,2,4), decomp = "cp", par_decom = 20, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_4_cpt_10_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = c(100, 150, 200, 250), size = 300, rho = c(0.8, 0.2, 0.8, 0.2, 0.8), num_subgraph = c(4,2,4,2,4), decomp = "cp", par_decom = 10, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_4_cpt_5_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = c(100, 150, 200, 250), size = 300, rho = c(0.8, 0.2, 0.8, 0.2, 0.8), num_subgraph = c(4,2,4,2,4), decomp = "cp", par_decom = 5, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_10_cpt_20_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = c(60, 120, 180, 240,300,360,420,480,540,600), size = 660, rho = c(0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8), num_subgraph = c(4,2,4,2,4,2,4,2,4,2,4), decomp = "cp", par_decom = 20, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_10_cpt_10_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = c(60, 120, 180, 240,300,360,420,480,540,600), size = 660, rho = c(0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8), num_subgraph = c(4,2,4,2,4,2,4,2,4,2,4), decomp = "cp", par_decom = 10, ac=0.7)
}
...
for (i in 1:100){
  print(i)
  SB_Tensors_10_cpt_5_components[[i]] <- tensor_creation_decomposition_SB(dims = c(20,20,20), N = c(60, 120, 180, 240,300,360,420,480,540,600), size = 660, rho = c(0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8,0.2,0.8), num_subgraph = c(4,2,4,2,4,2,4,2,4,2,4), decomp = "cp", par_decom = 5, ac=0.7)
}
...
SB_SIM0_cp_TenSeg_10_components <- simulation_study_SB_TenSeg(tensor = SB_Tensors_0_cpt_10_components, decomp_sim = "cp", points_sim = 10, true.cpt = integer(0), m = 100, seed = seed.temp)
...
table(SB_SIM10_cp_TenSeg_5_components$IDLinf_IC@dnc)
mean(SB_SIM10_cp_TenSeg_5_components$IDLinf_IC@time)
mean(SB_SIM10_cp_TenSeg_5_components$IDLinf_IC@dh)
